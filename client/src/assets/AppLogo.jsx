...
export default function AppLogo({ isMobile }) {
  ...
  return (
    <Fragment>
      ...
      {isMobile ? (
        <Typography variant='h6' color={theme.palette.grey[100]} fontWeight='bold' pl={1}>TWIZZ'S RECIPES</Typography>
      ) : (
        <Typography variant='h4' color={theme.palette.grey[100]} fontWeight='bold' pl={1}>TWIZZ'S RECIPES</Typography>
      )}
    </Fragment>
  )
}